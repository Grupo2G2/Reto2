...
<!--------------------DATOS ACTUALES-------------------->
	...
	<div class="tablaoculta">
		<table id="tabla_retos_modulos"	class='tablaretomodeditar'>
			<tr>
				<th>Curso</th>
				<th>Centro</th>
				<th>Ciclo</th>
	...
	$(document).ready(function(){
		...
		$("#botonMostrar").click(function(){
    		...
    		//SI SE HAN SELECCIONADO TODOS LOS PARÁMETROS.
		        ...
		        $('#tabla_retos_modulos').append($('<tr class="contenido"><td id="datosCurso">'+$("#select_curso option:selected").text()+'</td><td id="datosCentro">'+"<?php echo $reto->result()[0]->DESC_Centro; ?>"+'</td><td id="datosCiclo">'+$("#select_ciclo option:selected").text()+'</td><td id="datosModulo">'+$("#select_modulo option:selected").text()+'</td><td id="datosReto">'+"<?php echo $reto->result()[0]->COD_Reto; ?>"+'</td><td id="datosDescripcionReto">'+"<?php echo $reto->result()[0]->DESC_Reto; ?>"+'</td></tr>'));
